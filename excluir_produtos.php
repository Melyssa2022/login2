...
<input type="number" name="id" class="form-control" placeholder="Digite o ID do veículo que quer buscar">
...
echo"<input type='submit' class='btn btn-primary' name='botaoapagar' value='Apagar cadastro do Veículo'>";
